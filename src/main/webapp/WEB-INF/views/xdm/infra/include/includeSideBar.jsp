...
<%@ taglib prefix="rb" uri="http://www.springframework.org/tags" %>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="indexXdmView" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i></h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="/resources/img/portfolio/me.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="indexXdmView" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
