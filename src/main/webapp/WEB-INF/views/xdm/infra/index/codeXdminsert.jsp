...
<link href="/resources/css/adminXdm/owl.carousel.min.css"
	rel="stylesheet">
<link href="/resources/css/adminXdm/tempusdominus-bootstrap-4.min.css"
	rel="stylesheet" />
						...
						<div class="bg-secondary rounded h-100 p-4">
							...
							<form name="form" method="post">
								<div class="mb-3">
									...
									<input type="email" class="form-control" id="seq" name="seq"
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="dleNy" name="dleNy"
